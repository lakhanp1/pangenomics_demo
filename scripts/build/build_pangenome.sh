...
nohup \
    \
    cat analysis/03_pangenome_pecto_v2/subset_optimal_group/subsets_conf.tab | # sed -n '1,6!p' analysis/03_pangenome_pecto_v2/subset_optimal_group/subsets_conf.tab | \
...
for grp in core accessory unique; do
